...
alias o='xdg-open'
alias aptfullupgrade='sudo apt update && sudo apt full-upgrade -y && sudo apt autoremove -y && sudo apt autoclean -y'
...
alias os="echo lsb_release -a : ; lsb_release -a ; echo uname ; uname -a"
